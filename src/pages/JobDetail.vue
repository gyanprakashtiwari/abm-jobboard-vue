<template>
  ...
  <div class="py-4" v-if="job">
    ...
    <div class="row pt-4">
      <div class="col-md-8 col-12 d-flex flex-column gap-4 order-2 order-md-1">
        <div class="border bg-white rounded-3 p-4">
          <h5 class="mb-2">Job Description</h5>
          <div>
            <p>
              {{ job.fullDescription }} Lorem ipsum dolor sit amet, consectetur
              adipisicing elit. Magnam soluta eaque rerum modi asperiores quo
              voluptatibus, sed, libero incidunt odio a debitis ipsa culpa
              laudantium minima sequi in. Laboriosam, atque?
            </p>
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Voluptatum soluta harum nostrum tempora possimus ea commodi! Dicta
              tenetur explicabo odio numquam quod illo culpa officiis
          ...
          <div>
            <ul>
              <li>
                ...
                odit corrupti illo quis, voluptatibus, tempora optio.
              </li>
              <li>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit
                odit corrupti illo quis, voluptatibus, tempora optio.
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Optimize database queries and server response times.</li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Handle deployment, CI/CD pipelines, and cloud infrastructure
                    management.
                  </li>
                  <li>
